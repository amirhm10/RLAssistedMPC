...
\graphicspath{{./}{MACC2026/}{../Figures/}{../Polymer/Results/disturb_compare_combined_h_dqn_mismatch__m_td3_mismatch__w_td3_mismatch__r_td3_mismatch_rho/20260426_193431/}{Polymer/Results/disturb_compare_combined_h_dqn_mismatch__m_td3_mismatch__w_td3_mismatch__r_td3_mismatch_rho/20260426_193431/}}
...
\vspace{0.24cm}
\centering
{\color{maccgreen}\bfseries Same controller idea}\\[-0.02em]
{\tiny RL assists MPC rather than replacing it.}\\[-0.02em]
{\tiny MPC remains the constrained optimizer.}
}
\end{column}
\end{columns}
\end{frame}
...
%=========================================================
\begin{frame}
\PosterTitle{Project 2: RL-Assisted MPC Results}
\scriptsize
...
\vspace{0.05cm}
\FigurePanel{compare_rewards.png}{0.27\textheight}\\[-0.08em]
{\tiny Reward comparison, combined run.}

\vspace{0.05cm}
\FigurePanel{compare_outputs_last_episode.png}{0.30\textheight}\\[-0.08em]
{\tiny Latest evaluation episode output comparison.}
\end{column}

\begin{column}{0.39\textwidth}
\ColumnHeader{maccgreen}{Successful reward gains vs nominal MPC}
\vspace{0.06cm}
\TextPanel{maccgreen}{softgreen}{0.34\textheight}{%
\centering
...
\vspace{0.06cm}
\TextPanel{maccred}{softred}{0.20\textheight}{%
\centering
