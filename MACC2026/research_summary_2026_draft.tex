...
J. B. Rawlings, D. Q. Mayne, and M. M. Diehl, \emph{Model Predictive Control: Theory, Computation, and Design}, 2nd ed. Nob Hill Publishing, 2017.

\bibitem{fujimoto2018td3}
S. Fujimoto, H. van Hoof, and D. Meger, ``Addressing function approximation error in actor-critic methods,'' in \emph{Proceedings of ICML}, pp. 1587--1596, 2018.

\bibitem{hassanpour2024practically}
H. Hassanpour, P. Mhaskar, and B. Corbett, ``A practically implementable reinforcement learning control approach by leveraging offset-free model predictive control,'' \emph{Computers \& Chemical Engineering}, vol. 181, article 108511, 2024.

\bibitem{gros2020data}
S. Gros and M. Zanon, ``Data-driven economic NMPC using reinforcement learning,'' \emph{IEEE Transactions on Automatic Control}, vol. 65, no. 2, pp. 636--648, 2020.
...
K. P. Wabersich and M. N. Zeilinger, ``A predictive safety filter for learning-based control of constrained nonlinear dynamical systems,'' \emph{Automatica}, vol. 129, article 109597, 2021.
