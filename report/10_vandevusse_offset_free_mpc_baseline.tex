...
\qquad
T_{in} = [403.15,\; 403.15,\; 403.15,\; 403.15]~\mathrm{K}.
\]
...
The baseline should be rerun only after the Van de Vusse benchmark-consistent system-identification artifacts have been regenerated, because the offset-free MPC model depends directly on the corrected steady state, local Jacobians, and scaling artifacts.
