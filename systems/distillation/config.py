...
MATRIX_MULTIPLIER_BOUNDS = {
    "td3": {
        "low": np.array([DISTILLATION_MATRIX_ALPHA_DEFAULT_LOW, DISTILLATION_DEFAULT_MULTIPLIER_LOW, DISTILLATION_DEFAULT_MULTIPLIER_LOW], dtype=float),
        "high": np.array([min(DISTILLATION_MATRIX_ALPHA_DEFAULT_HIGH, DISTILLATION_MATRIX_ALPHA_UPPER_CAP), DISTILLATION_DEFAULT_MULTIPLIER_HIGH, DISTILLATION_DEFAULT_MULTIPLIER_HIGH], dtype=float),
    },
    "sac": {
        "low": np.array([DISTILLATION_MATRIX_ALPHA_DEFAULT_LOW, DISTILLATION_DEFAULT_MULTIPLIER_LOW, DISTILLATION_DEFAULT_MULTIPLIER_LOW], dtype=float),
        "high": np.array([min(DISTILLATION_MATRIX_ALPHA_DEFAULT_HIGH, DISTILLATION_MATRIX_ALPHA_UPPER_CAP), DISTILLATION_DEFAULT_MULTIPLIER_HIGH, DISTILLATION_DEFAULT_MULTIPLIER_HIGH], dtype=float),
